@echo off
REM Quick start script for ranking model training and evaluation (Windows)

echo 🚀 SocialCue Ranking System - Quick Start
echo ==========================================

REM Check if data exists
set DATA_FILE=..\..\data\processed\llm\ranking_labels_1000.jsonl
